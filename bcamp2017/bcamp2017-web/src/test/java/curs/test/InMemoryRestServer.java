 ...
 * <ul>
 * <li>InMemoryRestServer srv = InMemoryRestServer.create(...) passing your
 * resources and provider classes</li>
...
public class InMemoryRestServer implements AutoCloseable {
	...
	/**
	 * Begin a new {@link ResteasyWebTarget} with additional, relative path with
	 * leading /.
	 *
	 * @param uriTemplate
